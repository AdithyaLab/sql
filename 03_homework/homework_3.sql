...
SELECT * FROM vendor;
INSERT INTO temp.new_vendor (vendor_name, vendor_type, vendor_owner_first_name, vendor_owner_last_name, vendor_id)
VALUES ('Thomas Superfood Store', 'Fresh Focused', 'Thomas', 'Rosenthal', 10)
...
FROM customer_purchases
WHERE 
    strftime('%m', market_date) = '04' AND strftime('%Y', market_date) = '2019'
